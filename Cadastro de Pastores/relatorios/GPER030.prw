...
Private oFont2 			:=	TFont():New( "Verdana", 10, 10 , , .F., , , , .T., .F. )//Cabeçalho e Rodapé
Private oFont2N 		:= 	TFont():New( "Verdana", 10, 10, , .T., , , , .T., .F. )//Cabeçalho e Rodapé Negrito
...
*/	@ LI,131 PSAY "|"
	...
	ELSE
		LI ++
		@ LI,00  PSAY "| Recebi da instituição acima identificada, pelo exercicio de ministro religioso a importancia de: R$ " + TRANSFORM((TOTVENC-TOTDESC),cPict1) + CRLF + "| Na data de ___/___/___ " //"Recebi da instituição acima identificada, pelo exercicio de ministro religioso a importancia de: " + TRANSFORM((TOTVENC-TOTDESC),cPict1),oArial10N)
	//	@ li,131 PSAY "|"
	ENDIF
...
Local nLi			:= nPosFCab
	...
	nLi += 40
	oPrinter:SayAlign(nLi-25,005," Recebi da instituição acima identificada, pelo exercício de ministro religioso a importância de: R$ "+ Alltrim(TRANSFORM((TOTVENC-TOTDESC) , cPict3 )) ,oFont2N,585,005, , ALIGN_H_LEFT, 1 )
